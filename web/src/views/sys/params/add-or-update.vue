	...
	<el-dialog v-model="visible" :title="!dataForm.id ? '新增' : '修改'" :close-on-click-modal="false" :width="600">
		<el-form ref="dataFormRef" :model="dataForm" :rules="dataRules" label-width="100px" @keyup.enter="submitHandle()">
			...
			<el-form-item label="参数值" prop="paramValue">
				<el-input :rows="10" v-model="dataForm.paramValue" maxlength="2000" placeholder="参数值" show-word-limit type="textarea" />
			</el-form-item>
			<el-form-item label="备注" prop="remark">
				<el-input v-model="dataForm.remark" placeholder="备注"></el-input>
			</el-form-item>
			<el-form-item label="系统参数" prop="paramType">
				<fast-radio-group v-model="dataForm.paramType" dict-type="params_type"></fast-radio-group>
			</el-form-item>
		</el-form>
		<template #footer>
...
const submitHandle = () => {
	dataFormRef.value.validate((valid: boolean) => {
		...
		dataForm.paramType = Number(dataForm.paramType)
