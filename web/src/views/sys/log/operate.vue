<template>
	<el-card>
		...
		<el-table v-loading="state.dataListLoading" :data="state.dataList" border style="width: 100%" @selection-change="selectionChangeHandle">
			...
			<el-table-column prop="operateUser.username" label="用户" show-overflow-tooltip header-align="center" align="center"></el-table-column>
			...
			<el-table-column prop="ip" label="请求ip" show-overflow-tooltip header-align="center" align="center"></el-table-column>
			...
			<el-table-column prop="createTime" label="完成时间" show-overflow-tooltip header-align="center" align="center"></el-table-column>
...
const state: IHooksOptions = reactive({
	dataListUrl: 'admin_api/sys/operate_log_page',
	queryForm: {
		realName: '',
		reqUri: ''
	}
