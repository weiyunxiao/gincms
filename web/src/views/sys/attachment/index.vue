<template>
	<el-card>
		<el-form :inline="true" :model="state.queryForm" @keyup.enter="getDataList()">
			...
			<el-form-item v-auth="'post:/admin_api/sys/file_upload|'">
				<el-upload :action="constant.uploadUrl" :before-upload="beforeUpload" :on-success="handleSuccess" :show-file-list="false">
					<el-button type="primary">上传</el-button>
				</el-upload>
			</el-form-item>
			<el-form-item>
				<el-button v-auth="'delete:/admin_api/sys/attachment|'" type="danger" @click="deleteBatchHandle()">删除</el-button>
			</el-form-item>
		</el-form>
		<el-table v-loading="state.dataListLoading" :data="state.dataList" border style="width: 100%" @selection-change="selectionChangeHandle">
			...
			<el-table-column label="操作" fixed="right" header-align="center" align="center" width="150">
				<template #default="scope">
					<el-button v-auth="'post:/admin_api/down_file|'" type="primary" link @click="downloadHandle(scope.row.url, scope.row.name)">下载</el-button>
					<el-button v-auth="'delete:/admin_api/sys/attachment|'" type="primary" link @click="deleteBatchHandle(scope.row.id)">删除</el-button>
				</template>
			</el-table-column>
		</el-table>
		<el-pagination
...
const state: IHooksOptions = reactive({
	dataListUrl: 'admin_api/sys/attachment_page',
	deleteUrl: 'admin_api/sys/attachment',
	queryForm: {
		name: '',
		platform: ''
	}
